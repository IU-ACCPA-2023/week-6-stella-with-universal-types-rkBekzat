...
build/stella-interpreter: Visiting.cpp Visiting.h Enum.h src/Interpret.cpp src/TypeCheck.cpp src/TypeCheck.h src/VisitTypeCheck.cpp src/VisitTypeCheck.h src/Eval.cpp src/Eval.h src/Stella/TestStella CMakeLists.txt
	cmake -S. -Bbuild
